...
def test_plot_features_num_regression_devuelve_lista(monkeypatch):
    ...
    resultado = plot_features_num_regression(df, target_col="target", umbral_corr=0.8)
...
def test_plot_features_num_regression_lista_vacia_si_nada_correlado(monkeypatch):
    ...
    resultado = plot_features_num_regression(df, target_col="target", umbral_corr=0.99)
    assert resultado == []
